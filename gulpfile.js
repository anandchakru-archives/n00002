...
function modules() {
  ...
  var bootstrap = gulp.src('./node_modules/showdown/dist/*')
    .pipe(gulp.dest('./vendor/showdown'));

  // nivite
  var bootstrap = gulp.src('./node_modules/@nivite/nelem/nivite*')
    .pipe(gulp.dest('./vendor/nivite/js'));
